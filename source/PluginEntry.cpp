/**
	...
	`CFFGLPluginInfo` that Pitch.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Pitch.bundle/Contents/MacOS/Pitch | grep pitch
*/

extern "C" const char* PitchBuildStamp()
{
	return "pitch " PITCH_VERSION " built " __DATE__ " " __TIME__;
}
